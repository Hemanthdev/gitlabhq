...
gem 'rugged', '~> 0.28'
gem 'grape-path-helpers', '~> 1.3', '>= 1.3.0'
...
gem 'doorkeeper-openid_connect', '~> 1.7.0'
...
# Memory benchmarks
gem 'derailed_benchmarks', '>= 1.4.3', require: false
